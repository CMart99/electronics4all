        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +34 639 907 702</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> soporte@electronics4all.com</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i> Avda. Turia, 11, 41009 (Sevilla)</a></li>
                </ul>
                <ul class="header-links pull-right">
                    ...
                    <li><a href="{{route('user.signup')}}"><i class="fa fa-user-o"></i> Reg&iacute;strate</a></li>
                    @endif
                        ...
                        <div class="header-search">
                            <form action="{{route('user.search')}}" method="get">
                                <div class="custom_search_top" >
                                    ...
                                    <button  class="search-btn">B&uacute;squeda</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    @if(Route::is('user.search'))
                        ...
                        @endforeach
                        <li class="{{$a == -1  ? 'active' : ''}}"><a href="search">Todo</a></li>
                    @else
                        @foreach($cat as $c)
                        <li ><a href="{{route('user.search.cat',['id'=>$c->id])}}" >{{$c->name}}</a></li>
                        @endforeach
                        <li ><a href="{{route('user.search')}}">Todo</a></li>
                    @endif
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        ...
                        <div class="shop-body">
                            <h3>{{$c->name}}</h3>
                            <a href="search?c={{$c->id}}" class="cta-btn">Comprar ahora <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- /shop -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="newsletter">
                        <p>Suscr&iacute;bete a nuestra <strong>NEWSLETTER</strong></p>
                        <form>
                            <input class="input" type="email" placeholder="Enter Your Email">
                            <button class="newsletter-btn"><i class="fa fa-envelope"></i> Suscr&iacute;bete</button>
                        </form>
                ...
                <div class="row" >
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <p>Electronics4All es una empresa 100% sevillana, fundada en el año 2019 y dedicada a la venta de productos de electrónica y 
                                dom&oacute;tica.</p>
                            <ul class="footer-links">
                                <li><a href="#"><i class="fa fa-map-marker"></i>Avda. Turia, 11</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>+34 639 907 702</a></li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i>soporte@electronics4all.com</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="footer">
                            <h3 class="footer-title">Categor&iacute;as</h3>
                            <ul class="footer-links">
                                <li><a href="#">Ofertas</a></li>
                                <li><a href="#">Ordenadores</a></li>
                                <li><a href="#">Smartphones y telefon&iacute;a</a></li>
