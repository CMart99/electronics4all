...
<!--                            -->
                ...
                <div class="payment-method">
                    <div class="input-radio">
                        ...
                        <div class="caption">
                            <p>El producto ser&aacute; entregado en 24h.</p>
                        </div>
                    </div>
                </div>
                @if(session('user'))
                   ...
                   <center> <form method="post" name="cart">
                    ...
                    @else
                        <a href="{{route('user.home')}}"><input type="button"  class="primary-btn order-submit" value="Pedir"></a>
                    @endif
            ...
            <div class="col-md-7">
                ...
                <div class="billing-details">
                    <div class="section-title">
                        <h3 class="title">Direcci&oacute;n de facturaci&oacute;n</h3>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="input" type="text" name="zip" id="zip" placeholder="Código Postal">
                    </div>
                    <div class="form-group">
                        <input class="input" type="tel" name="tel" id="tel" placeholder="Teléfono">
                    </div>
                    <div class="form-group">
                        <input class="input" type="password" name="pass" id="pass" placeholder="Introduce tu contraseña">
                    </div>
                    <div class="form-group">
   ...
   //TO DO: ajax will take place
    ...
    $('.delete_item').click(function () {
        ...
        $.ajax({
                ...
                success:function(msg)
                {
                    if(msg=="Empty")
                        {
                        document.getElementById("order_summary").innerHTML = "<div class='order-col'><h1>El carrito está vacío</h1></div>";
    ...
    $(document).ready(function() {
		...
		$("#signupForm").validate({
			...
			messages: {
				name: "Por favor introduzca su nombre completo",
    ...
    var url="{{route('user.signup.check_email')}}";
            ...
            $.ajax({
                ...
                success:function(msg){
                        ...
                        if(msg == "1")
                            {
                                document.getElementById("for_duplicate-email").innerHTML = "<label class='error'>Esta dirección de email ya está en uso</label>";
